...
function LeaveHistory({ leaves, onStatusChange, isAdmin }) {
  ...
  return (
    <div className="mt-8 bg-gradient-to-br from-indigo-700 via-purple-700 to-blue-700rounded-2xl shadow-lg p-6 border border-white/10 hover:shadow-blue-400/40 hover:scale-105">
      {/* heading */}
