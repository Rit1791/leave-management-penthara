...
function LeaveHistory({ leaves, onStatusChange, isAdmin }) {
  ...
  return (
    <div className="mt-8 bg-gradient-to-br from-blue-600 via-purple-600 to-indigo-700 rounded-2xl shadow-lg p-6 border border-white/10 hover:shadow-blue-400/40 hover:scale-105">
      {/* heading */}
