...
function LeaveBalance({setLeaves , MAX_LEAVES} ) {
  ...
  return (
    <div>
          ...
          <div className={` bg-gradient-to-l from-blue-700 via-indigo-800 to-purple-90 backdrop-blur-md border ${leaveBalance === 0 ? 'border-red-500/60 shadow-red-400/40' : 'border-white/20 hover:shadow-blue-400/40'} rounded-xl p-4 text-center shadow-md w-fit mx-auto mb-6 hover:scale-105 transition-all`}>
